...
class Drawing:
    def __init__(self, sc, sc_map, player, clock):
        ...
        self.font_hp = pygame.font.SysFont("Arial", 20)
        self.font_win = pygame.font.Font('font/font.ttf', 144)
        self.textures = {1: pygame.image.load('assets/wall3.png').convert(),
                         2: pygame.image.load('assets/wall4.png').convert(),
                         3: pygame.image.load('assets/wall5.png').convert(),
                         4: pygame.image.load('assets/wall6.png').convert(),
                         'S': pygame.image.load('assets/sky2.png').convert()
                         }
        # menu
        self.menu_trigger = True
        self.menu_picture = pygame.image.load('assets/bg.jpg').convert()
        # weapon parameters
    ...
    def hp(self, player):
        health_txt = self.font_hp.render("HEALTH:", 0, WHITE)
        self.sc.blit(health_txt, (5, 5))
        pygame.draw.rect(self.sc, RED, (5, 30, 100, 20))
        pygame.draw.rect(self.sc, GREEN, (5, 30, player.hp, 20))
